    ...
    def __init__(self, cfg: Optional[Dict] = None):
        ...
        if fncall_prompt_type == 'qwen':
            ...
            raise NotImplementedError(
                f'Unsupported fncall_prompt_type: {fncall_prompt_type}. '
                f'Supported values are: qwen, nous, mistral, kimi, oss. '
                f'For oss_vllm model_type, use fncall_prompt_type="oss". '
                f'For mistral_vllm model_type, use fncall_prompt_type="mistral".'
            )
